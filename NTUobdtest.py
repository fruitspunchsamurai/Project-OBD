...
# OBD variables
BACKGROUND_FILENAME = "hive.jpg"
LOGO_FILENAME 		= "NTUlogo.jpg"
...
class OBDPanelGauges(wx.Panel):
    ...
    def refresh(self, event):
        ...
        cv2.putText(img,"ENGINE RPM",(120,130),font,1.5,(255,255,255),2,3)
        ##cv2.putText(img,"KM/H",(620,190),font,1.5,(255,255,255),2,3)
        cv2.putText(img,"SPEED",(650,130),font,1.5,(255,255,255),2,3)
        cv2.imshow('OBD',img)
        threshold = 90
        threshold2 = 110
        ...
        for index, sensor in sensors:
            ...
            if index==12:
                ...
                #conn.send(value)
                print value     
                cv2.putText(img,str(value),(150,240),font,2,(255,255,255),2,3)
                cv2.imshow('OBD',img)
            ...
            if index==13:
                ...
                ##print value
                print "%s KM/H" % value
                realspeed = float(value)
                value2 = value
                if (realspeed >= threshold) and (realspeed < threshold2):
                    cv2.rectangle(img,(980,580),(20,20),(0,0,255),3)
                elif realspeed >= threshold2:
                    cv2.rectangle(img,(980,580),(20,20),(0,0,255),3)
                    cv2.putText(img,"SLOW DOWN",(330,340),font,2,(0,0,255),2,3)
                else:
                    cv2.rectangle(img,(980,580),(20,20),(255,255,255),3)
                cv2.putText(img,str(value2)+"KM/H",(580,240),font,2,(255,255,255),2,3)
                cv2.imshow('OBD',img)
